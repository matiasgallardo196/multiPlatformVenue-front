...
export function TeamMembersSection({
    ...
    return (
      <Card className="h-full flex flex-col gap-0.5 lg:gap-1 py-1 min-h-0">
        <CardHeader className="flex-shrink-0 pb-0.5 lg:pb-0 px-3 sm:px-4 pt-0.5 lg:pt-0.5 gap-0.5">
          <CardTitle className="text-sm sm:text-base font-semibold">Team Members</CardTitle>
  ...
  return (
    <Card className="h-full flex flex-col gap-0.5 lg:gap-1 py-1 min-h-0">
      <CardHeader className="flex flex-row items-center justify-between flex-shrink-0 pb-0.5 lg:pb-0 px-3 sm:px-4 pt-0.5 lg:pt-0.5 gap-0.5">
        <div>
          <CardTitle className="text-sm sm:text-base font-semibold">Team Members</CardTitle>
          <CardDescription className="text-xs leading-tight">
            Users under your management
